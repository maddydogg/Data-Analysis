"""Design layers for the couples edition of the Annual Budget video (1080x1080).
...
draw_tracked(d, S / 2, 44, "FOR COUPLES & HOUSEHOLDS  ·  GOOGLE SHEETS & EXCEL", M600(16), MUTED, tr=4.0)
...
draw_tracked(d, S / 2, 950, "ONE LOG FEEDS THE WHOLE YEAR — AND SPLITS IT FAIRLY", M600(15), TEXT, tr=2.6)
draw_tracked(d, S / 2, 980, "10 tabs · every formula already written · yours to edit", M400(14), MUTED, tr=0.6)
