"""Design layers for the dark Debt Payoff video (1080x1080).
...
TABS = ["Start Here", "Setup", "Dashboard", "Debt Tracker"]
TAB_Y, TAB_H = 886, 32
...
draw_tracked(d, S / 2, 44, "SNOWBALL  ·  AVALANCHE  ·  CUSTOM  ·  GOOGLE SHEETS & EXCEL", M600(16), MUTED, tr=3.4)
draw_tracked(d, S / 2, 76, "Debt Payoff Plan", PF700(62), TEXT, tr=0.5)
...
d.text((WIN[0] + 108, WIN[1] + 25), "debt-payoff-2026", font=M500(13), fill=(104, 124, 160), anchor="lm")
chip_w = d.textlength("DOES THE MATH", font=M700(12)) + 1.6 * 12 + 26
d.rounded_rectangle([WIN[2] - 20 - chip_w, WIN[1] + 14, WIN[2] - 20, WIN[1] + 36], radius=11, fill=ACCENT)
draw_tracked(d, WIN[2] - 20 - chip_w / 2, WIN[1] + 18, "DOES THE MATH", M700(12), (8, 20, 14), tr=1.6)
...
draw_tracked(d, S / 2, 950, "PICK A METHOD — IT WORKS OUT THE ORDER, THE DATE AND THE INTEREST", M600(15), TEXT, tr=1.8)
draw_tracked(d, S / 2, 980, "4 tabs · snowball, avalanche or your own order · yours to edit", M400(14), MUTED, tr=0.6)
...
# ---------------------------------------------------------------- scenes
SCENES = [
    ("List your debts once",                  "Setup"),
    ("Snowball, Avalanche or your own order", "Setup"),
    ("Your debt-free date, worked out",       "Dashboard"),
    ("Change the method…",                    "Setup"),
    ("…and the date moves",                   "Dashboard"),
    ("What it costs, recalculated",           "Dashboard"),
    ("The balance falling to zero",           "Dashboard"),
    ("Log payments, watch each debt shrink",  "Debt Tracker"),
    ("$10,890 down · $25,150 to go",          "Debt Tracker"),
]
