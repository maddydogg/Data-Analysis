"""Design layers for the Debt Payoff video — paper frame (1080x1080).
...
left_tracked(d, LEFT + 34, 50, "SNOWBALL  ·  AVALANCHE  ·  CUSTOM  ·  GOOGLE SHEETS & EXCEL", M600(16), MUTED, 3.4)
d.text((LEFT + 34, 82), "Debt Payoff Plan", font=PF700(62), fill=INK)
...
d.text((WIN[0] + 108, WIN[1] + 25), "debt-payoff-2026", font=M500(13), fill=(154, 180, 166), anchor="lm")
chip = "DOES THE MATH"
...
left_tracked(d, LEFT + 26, 950, "PICK A METHOD — IT WORKS OUT THE ORDER, THE DATE AND THE INTEREST", M600(15), INK, 2.0)
left_tracked(d, LEFT + 26, 980, "4 tabs · snowball, avalanche or your own order · yours to edit", M400(14), MUTED, 0.6)
...
SCENES = [
    ...
    ("What it costs — and how far you are",  "Dashboard"),
    ("The order to pay them in",             "Dashboard"),
    ("The balance falling to zero",          "Dashboard"),
    ("Avalanche saves $744 — it tells you",  "Dashboard"),
    ("Change the method…",                   "Setup"),
    ("…and the whole plan recalculates",     "Dashboard"),
