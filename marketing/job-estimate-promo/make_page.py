...
This take wheels down in long steps — up to 280 px between rests — so the
alignment search runs to 320 rather than the 130 the earlier takes needed.
"""
...
H, CUT, TOP = 805, 44, 130        # viewport grid area, dropped bottom edge, dropped top edge
