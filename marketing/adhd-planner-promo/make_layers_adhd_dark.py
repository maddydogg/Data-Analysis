...
def tab_layout(d):
    """Three tabs — the product is three sheets, so the strip says so."""
    fnt = M600(13)
    tr = 1.1
...
draw_tracked(d, S / 2, 44, "THREE SHEETS  ·  TODAY  ·  TASKS  ·  HABITS", M600(16), MUTED, tr=3.4)
draw_tracked(d, S / 2, 76, "ADHD Planner", PF700(62), TEXT, tr=0.5)
...
d.text((WIN[0] + 108, WIN[1] + 25), "adhd-planner-2026", font=M500(13), fill=(104, 124, 160), anchor="lm")
...
draw_tracked(d, S / 2, 950, "THREE THINGS, NOT TEN — AND NOTHING BREAKS IF YOU MISS A DAY", M600(15), TEXT, tr=1.5)
draw_tracked(d, S / 2, 980, "today · tasks · habits · brain dump · dopamine menu · yours to edit", M400(14), MUTED, tr=0.6)
...
CAPTIONS = [
    ...
    "Tick one box — the month keeps count",
]
