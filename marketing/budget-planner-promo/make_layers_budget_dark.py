"""Design layers for the dark Budget Planner video (1080x1080).

Same ground as the other dark listing — deep navy, a green glow behind the
window so the dark sheet sits in light — keyed to this workbook's own colours,
which turn out to be the same #7BFFA4 headers on a #0E1123 sheet. Only two tab
pills here, because the product is two sheets and says so on its face, and the
captions are the light cut's: this film argues that everything is on one page.
"""
...
draw_tracked(d, S / 2, 44, "ONE PAGE  ·  ONE LOG  ·  GOOGLE SHEETS & EXCEL", M600(16), MUTED, tr=3.4)
draw_tracked(d, S / 2, 76, "Budget Planner", PF700(62), TEXT, tr=0.5)
...
d.text((WIN[0] + 108, WIN[1] + 25), "budget-planner-2026", font=M500(13), fill=(104, 124, 160), anchor="lm")
...
draw_tracked(d, S / 2, 950, "ONE PAGE DOES ALL OF IT — THE SECOND SHEET IS JUST THE LOG", M600(15), TEXT, tr=1.6)
draw_tracked(d, S / 2, 980, "plan vs actual · bills · funds · debts · all in one view", M400(14), MUTED, tr=0.6)
...
# ---------------------------------------------------------------- captions
# Timed against the film, not against shots: the page scrolls through one uncut
# take and the line over it changes while it moves.
CAPTIONS = [
